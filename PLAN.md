...
### CP1: Context & Assessor Profile Review
...
### CP2: Assessment Framework Review
...
**Editable elements (limited at CP3):**
...
### CP5: Reconciled Findings Review
...
**Editable elements (limited at CP5):**
| Element | Control | Effect |
|---------|---------|--------|
...
2. **Modified commands:**
   - `commands/pre-assess.md` — CP1, CP2, CP3 sections updated:
   ...
   - `commands/assess.md` — CP4, CP5 sections updated (same pattern)
...
- The rules (can only escalate, can't remove mandatory, scores locked at CP3/CP5)
...
3. Modify `commands/pre-assess.md` — update CP1, CP2, CP3 sections
4. Modify `commands/assess.md` — update CP4, CP5 sections
